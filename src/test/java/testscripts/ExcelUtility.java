...
public class ExcelUtility {
	...
	public String readStringData(String sheetname, int firstrowindexcount, int firstcellindexcount) throws Exception 
	{
		...
		String stringdata = workbook.getSheet(sheetname).getRow(firstrowindexcount).getCell(firstcellindexcount).getStringCellValue();
	...
	public double readNumericData(String sheetname, int firstrowindexcount , int firstcellindexcount) throws Throwable
	{
		...
		double numericdata = workbook.getSheet(sheetname).getRow(firstrowindexcount).getCell(firstcellindexcount).getNumericCellValue();
	...
	public CellType checkCellType(String sheetname, int firstrowindexcount , int firstcellindexcount) throws Throwable
	{
		...
		CellType celltype = workbook.getSheet(sheetname).getRow(firstrowindexcount).getCell(firstcellindexcount).getCellType();
