...
public class Notes { 
      ...
      public static void main(String[] args) throws Exception {
		...
		System.out.println(notes.readStringData("mydata", 1, 5));
		System.out.println(notes.readNumericData("mydata", 0, 5)); 
		System.out.println(notes.checkCellType("mydata", 0, 0));
		System.out.println(notes.sheetRowLimit("mydata"));
		System.out.println(notes.sheetCellLimit("mydata", 0));
		System.out.println(notes.getDataFromCell("mydata", 0, 0));
	}
 /** 
